 ...
 public:
  ...
  class ExperimentalWithCallbackMethod_put : public BaseClass {
   ...
   public:
    ...
    virtual void put(::grpc::ServerContext* context, const ::kvstore::PutRequest* request, ::kvstore::PutReply* response, ::grpc::experimental::ServerCallbackRpcController* controller) { controller->Finish(::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "")); }
  };
  template <class BaseClass>
  ...
  class ExperimentalWithCallbackMethod_remove : public BaseClass {
   ...
   public:
    ...
    virtual void remove(::grpc::ServerContext* context, const ::kvstore::RemoveRequest* request, ::kvstore::RemoveReply* response, ::grpc::experimental::ServerCallbackRpcController* controller) { controller->Finish(::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "")); }
  };
